...
function selectOption(option) {
    ...
    if (option === 'yes') {
        ...
        flashRainbowColors(function() {
            ...
            displayFrog(); // Display the cat-heart.gif
        });
    } else if (option === 'no') {
...
function displayMessage() {
    document.getElementById('no-button').innerText = 'Hey Catherine, my 0.5 valentine, happy valentines day! I have written enough letters to express my feelings towards you. I think about our time in Shanghai everyday, and I miss it dearly. I only wish to have you hear by my side, so that I can hold you in my arms and kiss you, and to explore all these places with you. Would you happen to be willing to go on an adventure with me to Guam?'; 
}
